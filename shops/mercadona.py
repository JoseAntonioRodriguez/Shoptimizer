...
class Mercadona(Shop):
    ...
    def get_product_list_page(self):
        ...
        resp = session.get("https://www.mercadona.es/sfprincipal.php?page=sflista&id_padre=&id_seccion=&id_lista=" + self.id_lista + "&ind=0") #12840115
        self.log(resp)
    ...
    def parse_product_list_page(self, html_page):
        ...
        for product_item in product_list:
            ...
            product_unitary_price = product_item.xpath("./td[2]/span[contains(concat(' ', normalize-space(@class), ' '), ' precio_ud ')]")
